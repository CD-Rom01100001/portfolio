...
export const allProjects: ProjectType[] = [
  {
    title: 'Momentum',
    description: {
      ru: 'Momentum - аналог одноимённого приложения интернет-магазина Chrome. Приложение показывает время и имя пользователя. Фоновое изображение и приветствие меняются в зависимости от времени суток. В приложении есть часы, слайдер изображений, виджеты погоды, аудиоплеер, блок цитата дня, настройки. Для хранения имени пользователя и населённого пункта используется локальное хранилище - local storage. Создано в рамках обучения в онлайн школе программирования RS School и репозиторий приватный. При необходимости могу показать всю историю коммитов по видеосвязи.',
      en: "Momentum is an analog of the Chrome Web Store app of the same name. The app shows the time and the user's name. The background image and greeting change depending on the time of day. The app has a clock, image slider, weather widgets, audio player, quote of the day block, and settings. Local storage - local storage is used to store username and locality. Created as part of training at the RS School online programming school, and the repository is private. If necessary, I can show the entire commit history via video link."
    },
  ...
  },
  {
    title: 'Shelter',
    description: {
      ru: 'Shelter — это адаптивный лендинг для приюта домашних животных. Он создан в рамках образовательного курса Rolling Scopes School и демонстрирует навыки верстки, адаптивного дизайна и работы с JavaScript без фреймворков. Создано в рамках обучения в онлайн школе программирования RS School и репозиторий приватный. При необходимости могу показать всю историю коммитов по видеосвязи.',
      en: "Shelter is an adaptive webpage for a pet shelter. It was created as part of the Rolling Scopes School educational course and demonstrates layout, responsive design and JavaScript skills without frameworks. Created as part of training at the RS School online programming school, and the repository is private. If necessary, I can show the entire commit history via video link."
    },
  ...
  },
  {
    ...
    repoLink: 'https://github.com/CD-Rom01100001/tests-react-typescript-redux/tree/tests-react-typescript-redux',
  ...
  },
  {
    ...
    repoLink: 'https://github.com/CD-Rom01100001/portfolio/tree/portfolio',
