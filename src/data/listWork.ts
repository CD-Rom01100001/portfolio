...
export const allProjects: ProjectType[] = [
  ...
  {
    title: 'Shelter',
    description: 'Shelter — это адаптивный лендинг для приюта домашних животных. Он создан в рамках образовательного курса Rolling Scopes School и демонстрирует навыки верстки, адаптивного дизайна и работы с JavaScript без фреймворков. Создано в рамках обучения в онлайн школе программирования RS School.',
